...
module prim_secded_hamming_39_32_cor (
  input        [38:0] d_i,
  ...
  assign syndrome_o[0] = ^(d_i & 39'h0156AAAD5B);
  assign syndrome_o[1] = ^(d_i & 39'h029B33366D);
  assign syndrome_o[2] = ^(d_i & 39'h04E3C3C78E);
...
endmodule : prim_secded_hamming_39_32_cor
