...
module prim_secded_32_26_dec (
  input        [31:0] in,
  output logic [25:0] d_o,
  ...
  assign syndrome_o[0] = ^(in & 32'h05F003FF);
  assign syndrome_o[1] = ^(in & 32'h0AF0FC0F);
  assign syndrome_o[2] = ^(in & 32'h13771C71);
  assign syndrome_o[3] = ^(in & 32'h23BB6592);
  assign syndrome_o[4] = ^(in & 32'h43DDAAA4);
  assign syndrome_o[5] = ^(in & 32'h83EED348);
  ...
  assign d_o[21] = (syndrome_o == 6'h2f) ^ in[21];
  assign d_o[22] = (syndrome_o == 6'h37) ^ in[22];
  assign d_o[23] = (syndrome_o == 6'h3b) ^ in[23];
  assign d_o[24] = (syndrome_o == 6'h3d) ^ in[24];
  assign d_o[25] = (syndrome_o == 6'h3e) ^ in[25];
