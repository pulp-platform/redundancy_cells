...
module ecc_manager_2_reg_top #(
  ...
  // To HW
  output ecc_manager_2_reg_pkg::ecc_manager_2_reg2hw_t reg2hw, // Write
  input  ecc_manager_2_reg_pkg::ecc_manager_2_hw2reg_t hw2reg, // Read
  ...
  logic [6:0] write_mask_ecc_n_write_mask_ecc_n_0_qs;
  logic [6:0] write_mask_ecc_n_write_mask_ecc_n_0_wd;
  logic write_mask_ecc_n_write_mask_ecc_n_0_we;
  logic [6:0] write_mask_ecc_n_write_mask_ecc_n_1_qs;
  logic [6:0] write_mask_ecc_n_write_mask_ecc_n_1_wd;
  logic write_mask_ecc_n_write_mask_ecc_n_1_we;
  ...
  prim_subreg #(
    ...
    .SWACCESS("RW"),
    .RESVAL  (7'h0)
  ) u_write_mask_ecc_n_write_mask_ecc_n_0 (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),

    // from register interface
    .we     (write_mask_ecc_n_write_mask_ecc_n_0_we),
    .wd     (write_mask_ecc_n_write_mask_ecc_n_0_wd),
    ...
    // to register interface (read)
    .qs     (write_mask_ecc_n_write_mask_ecc_n_0_qs)
  );
  ...
  prim_subreg #(
    ...
    .SWACCESS("RW"),
    .RESVAL  (7'h0)
  ) u_write_mask_ecc_n_write_mask_ecc_n_1 (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),

    // from register interface
    .we     (write_mask_ecc_n_write_mask_ecc_n_1_we),
    .wd     (write_mask_ecc_n_write_mask_ecc_n_1_wd),
    ...
    // to register interface (read)
    .qs     (write_mask_ecc_n_write_mask_ecc_n_1_qs)
  );
  ...
  always_comb begin
    ...
    addr_hit[1] = (reg_addr == ECC_MANAGER_2_MISMATCH_COUNT_1_OFFSET);
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[0] & (|(ECC_MANAGER_2_PERMIT[0] & ~reg_be))) |
               (addr_hit[1] & (|(ECC_MANAGER_2_PERMIT[1] & ~reg_be))) |
               (addr_hit[2] & (|(ECC_MANAGER_2_PERMIT[2] & ~reg_be))) |
               (addr_hit[3] & (|(ECC_MANAGER_2_PERMIT[3] & ~reg_be))) |
  ...
  assign scrub_interval_we = addr_hit[2] & reg_we & !reg_error;
  assign scrub_interval_wd = reg_wdata[31:0];

  assign scrub_fix_count_0_we = addr_hit[3] & reg_we & !reg_error;
