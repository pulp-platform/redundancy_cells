...
#define ECC_MANAGER_MISMATCH_COUNT_REG_OFFSET 0x100

// Interval between scrubs
#define ECC_MANAGER_SCRUB_INTERVAL_REG_OFFSET 0x104

// Correctable mismatches caught by ecc on scrub
#define ECC_MANAGER_SCRUB_FIX_COUNT_REG_OFFSET 0x108

// Uncorrectable mismatches caught by ecc on scrub
#define ECC_MANAGER_SCRUB_UNCORRECTABLE_COUNT_REG_OFFSET 0x10c

// Testing: Inverted write mask for data bits
#define ECC_MANAGER_WRITE_MASK_DATA_N_REG_OFFSET 0x110

// Testing: Inverted write mask for ECC bits
#define ECC_MANAGER_WRITE_MASK_ECC_N_REG_OFFSET 0x114
