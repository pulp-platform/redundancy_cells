...
module hmr_registers_reg_top #(
  ...
  always_comb begin
    ...
    addr_hit[1] = (reg_addr == HMR_REGISTERS_DMR_ENABLE_OFFSET);
    addr_hit[2] = (reg_addr == HMR_REGISTERS_TMR_ENABLE_OFFSET);
    addr_hit[3] = (reg_addr == HMR_REGISTERS_TMR_CONFIG_OFFSET);
  end
