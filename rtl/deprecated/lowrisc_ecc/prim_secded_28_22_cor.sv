...
module prim_secded_28_22_cor (
  input        [27:0] d_i,
  output logic [27:0] d_o,
  ...
  assign d_o[25] = (syndrome_o == 6'h8) ^ d_i[25];
  assign d_o[26] = (syndrome_o == 6'h10) ^ d_i[26];
  assign d_o[27] = (syndrome_o == 6'h20) ^ d_i[27];
...
endmodule : prim_secded_28_22_cor
