...
module prim_secded_hamming_72_64_cor (
  input        [71:0] d_i,
  ...
  assign syndrome_o[0] = ^(d_i & 72'h01AB55555556AAAD5B);
  assign syndrome_o[1] = ^(d_i & 72'h02CD9999999B33366D);
  assign syndrome_o[2] = ^(d_i & 72'h04F1E1E1E1E3C3C78E);
  assign syndrome_o[3] = ^(d_i & 72'h0801FE01FE03FC07F0);
...
endmodule : prim_secded_hamming_72_64_cor
