...
module prim_secded_72_64_dec (
  ...
  assign d_o[56] = (syndrome_o == 8'hd9) ^ in[56];
  assign d_o[57] = (syndrome_o == 8'hbc) ^ in[57];
  assign d_o[58] = (syndrome_o == 8'he6) ^ in[58];
  assign d_o[59] = (syndrome_o == 8'hb6) ^ in[59];
  assign d_o[60] = (syndrome_o == 8'h79) ^ in[60];
  assign d_o[61] = (syndrome_o == 8'h1f) ^ in[61];
  assign d_o[62] = (syndrome_o == 8'h4f) ^ in[62];
  assign d_o[63] = (syndrome_o == 8'he3) ^ in[63];
